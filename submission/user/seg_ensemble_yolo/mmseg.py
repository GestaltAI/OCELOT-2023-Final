...
class SegmentationInference():
    ...
    def __init__(self, metadata:dict) -> None:
        ...
        # :1 
        # :2 
        # :3 {'Pre/BC': 0.7486, 'Rec/BC': 0.8329, 'F1/BC': 0.7885, 'Pre/TC': 0.9005, 'Rec/TC': 0.8439, 'F1/TC': 0.8713, 'mF1': 0.72355}

        self.models = []
        for model_path, cfg_path in [
            (_checkpoints_path / "segformer_b2/iter_20000.pth", _checkpoints_path / "segformer_b2/config.py"),
    ...
    def load_checkpoint(self, model_path, cfg_path):
