...
log_level = 'INFO'
load_from = '/content/segformer_mit-b2_8x1_1024x1024_160k_cityscapes_20211207_134205-6096669a.pth'
resume = False
...
train_cfg = dict(type='IterBasedTrainLoop', max_iters=45000, val_interval=500)
...
work_dir = 'logs/fold_0/SegFormer-B2'
            ...
            init_kwargs=dict(
                ...
                config=dict(
                    ...
                    train_pipeline=[
                        ...
                        dict(type='RandomFlip', prob=0.5),
                        dict(
                            type='RandomFlip', direction='vertical', prob=0.5),
                        dict(type='RandomRotate', degree=(-45, 45), prob=0.5),
                        dict(type='PhotoMetricDistortion'),
                        dict(type='PackSegInputs')
                    ],
                    ...
                    log_level='INFO',
                    load_from=
                    '/content/segformer_mit-b2_8x1_1024x1024_160k_cityscapes_20211207_134205-6096669a.pth',
                    resume=False,
                    tta_model=dict(type='SegTTAModel'),
                    optimizer=dict(
                    ...
                    default_hooks=dict(
                        ...
                        sampler_seed=dict(type='DistSamplerSeedHook'),
                        visualization=dict(
                            type='SegVisualizationHook', draw=True)),
                    img_norm_cfg=dict(
                        mean=[123.675, 116.28, 103.53],
                        std=[58.395, 57.12, 57.375],
                        to_rgb=True),
