...
parser = argparse.ArgumentParser(description='Calculate mF1 score.')
parser.add_argument('--gt_file', type=str, 
                    default="/mnt/c/ProgProjekte/Python/OCELOTMICCAI23/ocelot23algo/test/fold_0/output/gt.json", 
                    help='Path to the ground truth file')
parser.add_argument('--prediction_file', type=str, 
                    default="/mnt/c/ProgProjekte/Python/OCELOTMICCAI23/ocelot23algo/test/fold_0/output/cell_classification.json", 
                    help='Path to predicted cells file')
...
def main():
    ...
    algorithm_output_path = args.prediction_file 
